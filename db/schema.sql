...
--
-- Name: bid_event; Type: TYPE; Schema: api; Owner: -
--
...
--
-- Name: COLUMN bid_event.block_height; Type: COMMENT; Schema: api; Owner: -
--

COMMENT ON COLUMN api.bid_event.block_height IS '@omit';


--
-- Name: COLUMN bid_event.tx_idx; Type: COMMENT; Schema: api; Owner: -
--

COMMENT ON COLUMN api.bid_event.tx_idx IS '@omit';


--
-- Name: COLUMN bid_event.contract_address; Type: COMMENT; Schema: api; Owner: -
--

COMMENT ON COLUMN api.bid_event.contract_address IS '@omit';
...
--
-- Name: all_bid_events(); Type: FUNCTION; Schema: api; Owner: -
--

CREATE FUNCTION api.all_bid_events() RETURNS SETOF api.bid_event
    LANGUAGE sql STABLE
    AS $$
SELECT *
