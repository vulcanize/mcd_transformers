...
var _ = Describe("Executing the transformer", func() {
	...
	It("reads in a vat storage diff row and persists it", func() {
		...
		vatRow := utils.StorageDiff{
			KeccakOfContractAddress: utils.HexToKeccak256Hash("7a4991c6bd1053c31f1678955ce839999d9841b1"), BlockHeight: blockNumber,
	...
	It("reads in a cdpi storage diff row and persists it", func() {
		...
		cdpiRow := utils.StorageDiff{
			KeccakOfContractAddress: utils.HexToKeccak256Hash("7a4991c6bd1053c31f1678955ce839999d9841b1"),
