...
var _ = Describe("Executing the transformer", func() {
	...
	It("reads in a Vow.vat storage diff row and persists it", func() {
		...
		vowVat := utils.StorageDiff{
			KeccakOfContractAddress: utils.HexToKeccak256Hash("17560834075da3db54f737db74377e799c865821"),
	...
	It("reads in a Vow.flapper storage diff row and persists it", func() {
		...
		vowFlapper := utils.StorageDiff{
			KeccakOfContractAddress: utils.HexToKeccak256Hash("21444ac712ccd21ce82af24ea1aec64cf07361d2"),
			BlockHeight:             blockNumber,
	...
	It("reads in a Vow.sump storage diff row and persists it", func() {
		...
		vowSump := utils.StorageDiff{
			KeccakOfContractAddress: utils.HexToKeccak256Hash("4afcab85f27dd2e1a5ec1008b5b294e44e487f90"),
			BlockHeight:             blockNumber,
